...
# this is the default:
export HDFS_NAMENODE_OPTS="-Dhadoop.security.logger=INFO,RFAS -Xmx512m -XX:ParallelGCThreads=2 -XX:+UseG1GC"
...
#
# This is the default:
export HDFS_DATANODE_OPTS="-Dhadoop.security.logger=ERROR,RFAS -Xmx256m -XX:ParallelGCThreads=1 -XX:+UseG1GC"
