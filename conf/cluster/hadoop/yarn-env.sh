...
#
#
export YARN_RESOURCEMANAGER_OPTS="-Xmx1152m -Drm.audit.logger=INFO,RMAUDIT -XX:ParallelGCThreads=2 -XX:+UseG1GC"
...
#
export YARN_NODEMANAGER_OPTS="-Xmx512m -Dnm.audit.logger=INFO,NMAUDIT -XX:ParallelGCThreads=1 -XX:+UseG1GC"
